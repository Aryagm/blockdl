...
import { initializeLayerDefs } from './src/lib/yaml-layer-loader'
...
async function runAllTests() {
  ...
  try {
    ...
    console.log(`✅ Loaded ${Object.keys(layerDefs).length} layer definitions from YAML\n`)
