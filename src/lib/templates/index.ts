...
export const templates: NetworkTemplate[] = [
  ...
  // 🟩 Image Classifier (LeNet-style CNN)
  {
    ...
    description: 'Classic CNN for image classification - the "Hello World" of computer vision',
    icon: '🖼️',
  ...
  // 🟦 Text Classifier (Embedding + LSTM)
  {
    ...
    description: 'Sequence modeling for text classification with embeddings and LSTM',
    icon: '📝',
  ...
  "edges": [
    ...
    metadata: {
      inputShape: [100],
      outputClasses: 1,
      useCase: 'Sentiment analysis, text classification, document categorization',
      performance: {
  ...
  // 🟥 Autoencoder (Dense Bottleneck)
  {
    ...
    description: 'Symmetrical encoder-decoder for dimensionality reduction and reconstruction',
    icon: '🔄',
  ...
  // 🟪 ResNet Block Mini (with Skip Connection)
  {
    id: 'resnet-mini',
    name: 'ResNet Mini Block',
    description: 'Residual network with skip connections demonstrating functional architecture',
    icon: '🔗',
  ...
  "edges": [
    ...
    metadata: {
      inputShape: [32, 32, 3],
      outputClasses: 10,
      useCase: 'CIFAR-10, demonstrating residual connections and functional API',
      performance: {
