 ...
 */
export function generateKerasCode(layers) {
    if (layers.length === 0) {
 ...
 */
export async function generateFunctionalKerasCode(dagResult) {
    ...
    const codeLines = [...imports, ''];
    // Track variable assignments
    const layerVariables = new Map();
